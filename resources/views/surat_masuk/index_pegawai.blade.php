                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('surat_masuk.view', ['id' => $Smasuk->id]) }}">
                                                    {{ $Smasuk->Smasuk->no_surat }}
                                                </a>
                                            </td>
                                            <td>{{ $Smasuk->Smasuk->sifat }}</td>
                                            <td>{{ $Smasuk->Smasuk->pengirim }}</td>
                                            <td>
                                                @can('read role')
                                                    @if (!optional($Smasuk)->tujuan)
                                                        <a href="#" class="btn btn-success btn-sm btn-location-arrow"
                                                            data-bs-toggle="modal" data-bs-target="#largeModal"
                                                            data-id-surat="{{ $Smasuk->id }}">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('surat_masuk.edit', $Smasuk->id) }}"
                                                    class="btn btn-warning btn-sm">
                                                    <i class="fas fa-pen"></i>
                                                </a>

                                                <form action="{{ route('surat_masuk.destroy', $Smasuk->id) }}"
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="tujuan"
                                                            ...
                                                            @foreach ($jabatan as $jabatan)
                                                                <option value="{{ $jabatan->nm_jabatan }}">
